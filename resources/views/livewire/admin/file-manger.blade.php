<div class=" w-full">
    <div>
        <div x-data="{ uploading: false,fileLoded:false, progress: 0  }"
            ...
            <div
            x-ref="dnd" 
                class=" relative flex w-1/2  flex-col items-center justify-center h-30 m-10 border-2 border-dashed  hover:border-primary hover:border-3 bg-slate-50 rounded-lg 
