        ...
        <div x-data="{showCancle:false}" class="flex items-center justify-center  m-2 ">
          @if ($product->image)
            <div @mouseenter="showCancle=true" @mouseleave="showCancle=false"
              ...
              <img  :class="{'blur-sm' : showCancle==true}"  
               class="rounded-lg  object-contain " src="{{tenant_asset('media/'.$product->image)}}"  />
              <button wire:click="removeImage" x-show="showCancle"
    ...
    <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      ...
      <div class="flex flex-col gap-5.5 p-6.5">
        ...
        <div>
          ...
          <livewire:admin.file-manger wire:model='files' :$product />
