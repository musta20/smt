<div class="w-full  bg-white  rounded-md border-l-2  border-r-2 border-b-2  border-gray-30 text-gray-700  hover:shadow-md   ">
    <div class="w-full rounded-t-md overflow-hidden max-h-60">
