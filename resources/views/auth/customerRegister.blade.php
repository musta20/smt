    ...
    <div class="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
        <div class="w-full p-4 sm:p-12.5 xl:p-17.5"> <span class="mb-1.5 block font-medium">Start for free</span>
            ...
            <form method="POST" action="{{ route('register') }}">
                @csrf              
                  <div class="mb-4">
                    <label :value="__('messages.Name')" class="mb-2.5 block font-medium text-black dark:text-white">Name</label>
                    <div class="relative">
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        <input type="email" :value="__('messages.Email')" placeholder="Enter your email"
                            class="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
