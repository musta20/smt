            ...
            <div class="rounded-sm border p-5 border-stroke bg-white shadow-default ">
                ...
                <div class="flex  text-slate-600 p-2 flex-col gap-5.5 p-6.5 xl:flex-row">
                    <div class="w-full  p-5 xl:w-1/2">
                        {{__('Adress')}} : {{$store->address}}
                    </div>
                    <div class="w-full  p-5 xl:w-1/2">
                        {{__('Phone')}} : {{$store->phone}}
                    </div>
                    <div class="w-full  p-5 xl:w-1/2">
                ...
                <div class="flex  p-2 flex-col gap-5.5 p-6.5 xl:flex-row">
                    <div class="w-full  p-5 xl:w-1/2">
                        ...
                        <input type="text" multiple="" name="title" placeholder="{{__('first name')}}"
                    ...
                    <div class="w-full  p-5 xl:w-1/2">
                        ...
                        <input type="text" name="specialty" value="" placeholder="{{__('last name')}}"
                ...
                <div class="flex  p-2 flex-col gap-5.5 p-6.5 xl:flex-row">
                    <div class="w-full  p-5 xl:w-1/2">
                        ...
                        <input type="text" multiple="" name="phone" value="" placeholder="{{__('phone number')}}"
                ...
                <div class="flex flex-col gap-5.5 p-6.5">
                    ...
                    <textarea rows="6" name="Message" placeholder="{{__('Message Content')}}"
                        class="w-full p-5
