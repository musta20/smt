        ...
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
                ...
                <div
                    class="rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default">
                    <div class="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-meta-2">
                        <svg class="fill-primary" width="22" height="18" viewBox="0 0 22 18" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <div>
                        <a href="messages.html"
                            ...
                            <div class="relative h-14 w-14 rounded-full">
                                <img src="{{ Vite::asset('resources/images/user/user-03.png') }}" alt="User" />
                                <span
                            ...
                            <div class="flex flex-1 items-center justify-between">
                                <div>
                                    ...
                                    <p>
                                        <span class="text-sm font-medium text-black">Hello, how are
                                            you?</span>
                        ...
                        <a href="messages.html"
                            class="flex items-center gap-5 px-7.5 py-3 hover:bg-gray-3">
                            <div class="relative h-14 w-14 rounded-full">
                                <img src="{{ Vite::asset('resources/images/user/user-04.png') }}" alt="User" />
                                <span
                                    class="absolute bottom-0 right-0 h-3.5 w-3.5 rounded-full border-2 border-white bg-meta-3"></span>
                            </div>
                        ...
                        <a href="messages.html"
                            class="flex items-center gap-5 px-7.5 py-3 hover:bg-gray-3">
                            <div class="relative h-14 w-14 rounded-full">
                                <img src="{{ Vite::asset('resources/images/user/user-05.png') }}" alt="User" />
                                <span
                        ...
                        <a href="messages.html"
                            class="flex items-center gap-5 px-7.5 py-3 hover:bg-gray-3">
                            <div class="relative h-14 w-14 rounded-full">
                                <img src="{{Vite::asset('resources/images/user/user-01.png') }}" alt="User" />
                                <span
                                    class="absolute bottom-0 right-0 h-3.5 w-3.5 rounded-full border-2 border-white bg-meta-3"></span>
                            </div>
                            ...
                            <div class="flex flex-1 items-center justify-between">
                                <div>
                                    ...
                                    <p>
                                        <span class="text-sm font-medium text-black">Thank you so
                                            much!</span>
                        ...
                        <a href="messages.html"
                            class="flex items-center gap-5 px-7.5 py-3 hover:bg-gray-3">
                            <div class="relative h-14 w-14 rounded-full">
                                <img src="{{ Vite::asset('resources/images/user/user-02.png') }}" alt="User" />
                                <span
